...
public class SignatureView extends View {
     ...
     * 
     * @param color
     *            the hex representation of the desired color, most likely an instance of Color.*
     */
    public void setSigColor(final int color) {
     ...
     *            blue value\
     */
    public void setSigColor(final int a, final int r, final int g, final int b) {
